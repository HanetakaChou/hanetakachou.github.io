...
1. Actually, the $\displaystyle \operatorname{a_p}$ is not calculated at all, and the $\displaystyle \frac{\operatorname{a_p}}{||\operatorname{a_p}||_1}$ is pre-integrated on the **ring** instead.  
