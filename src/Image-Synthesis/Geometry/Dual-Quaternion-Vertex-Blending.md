...
##### 1-1-7-1\. Mapping from Rotation Transformations to Unit Quaternions  
...
#### 1-3-5\. Bijection between Rigid Transformations and Unit Dual Quaternions  

By \[Kavan 2007\] and \[Kavan 2008\], the rigid transformation is the composition of rotation transform and translation transform.  

By "Lemma 12" of \[Kavan 2008\], we have that each rigid transformation can be represented by a unit dual quaternion, and conversely, each unit dual quaternion can represent a rigid transformation.  
