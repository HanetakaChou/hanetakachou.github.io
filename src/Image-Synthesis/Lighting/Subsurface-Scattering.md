...
### 3-1\. PreIntegrated SSS  

The PreIntegrated SSS by \[Penner 2011\] is implemented by the [NVIDIA FaceWorks](https://github.com/NVIDIAGameWorks/FaceWorks) and the [Preintegrated Skin Shading Model](https://docs.unrealengine.com/4.27/en-US/RenderingAndGraphics/Materials/MaterialProperties/LightingModels/#preintegratedskin) of UE4.  
...
The main idea of the Separable SSS is to approximate the diffusion profile kernel by the separable kernel.  
