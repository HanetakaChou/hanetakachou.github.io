...
By \[Wyman 2023\], we use the **MIS (multiple importance sampling)** to support multiple **target functions**.  
...
By ["13.10.1 Multiple Importance Sampling"](https://www.pbr-book.org/3ed-2018/Monte_Carlo_Integration/Importance_Sampling#MultipleImportanceSampling) of "PBR Book V3" and ["2.2.3 Multiple Importance Sampling"](https://pbr-book.org/4ed/Monte_Carlo_Integration/Improving_Efficiency#MultipleImportanceSampling) of "PBR Book V4", we have **MIS (multiple importance sampling)** estimator $\displaystyle \int \mathop{\mathrm{f}} (x) \, dx \approx \frac{1}{n_a} \sum_{i=1}^{n_a} \mathop{\mathrm{w_a}} (X_i) \frac{\mathop{\mathrm{f}} (X_i)}{\mathop{\mathrm{p_a}} (X_i)} + \frac{1}{n_b} \sum_{i=1}^{n_b} \mathop{\mathrm{w_b}} (Y_i) \frac{\mathop{\mathrm{f}} (Y_i)}{\mathop{\mathrm{p_b}} (Y_i)}$ where f is any function, the $\displaystyle n_a$ samples $\displaystyle X_i$ are generated from the **proposal distribution** with the **PDF** $\displaystyle \mathop{\mathrm{p_a}}$ and the **balance heuristic** **weight** $\displaystyle \mathop{\mathrm{w_a}} (X_i) = \frac{\displaystyle n_a \mathop{\mathrm{p_a}} (X_i)}{\displaystyle n_a \mathop{\mathrm{p_a}} (X_i) + n_b \mathop{\mathrm{p_b}} (X_i)}$, and the $\displaystyle n_b$ samples $\displaystyle Y_i$ are generated from the **proposal distribution** with the **PDF** $\displaystyle \mathop{\mathrm{p_b}}$ the **balance heuristic** **weight** $\displaystyle \mathop{\mathrm{w_b}} (Y_i) = \frac{\displaystyle n_b \mathop{\mathrm{p_b}} (Y_i)}{\displaystyle n_a \mathop{\mathrm{p_a}} (Y_i) + n_b \mathop{\mathrm{p_b}} (Y_i)}$.  

> Unbiased  
>>  
>> $\displaystyle \mathop{\mathrm{E_{p_a}}} \left( \frac{1}{n_a} \sum_{i=1}^{n_a} \mathop{\mathrm{w_a}} (X_i) \frac{\mathop{\mathrm{f}} (X_i)}{\mathop{\mathrm{p_a}} (X_i)} \right) + \mathop{\mathrm{E_{p_b}}} \left( \frac{1}{n_b} \sum_{i=1}^{n_b} \mathop{\mathrm{w_b}} (Y_i) \frac{\mathop{\mathrm{f}} (Y_i)}{\mathop{\mathrm{p_b}} (Y_i)} \right) = \frac{1}{n_a} \sum_{i=1}^{n_a} \mathop{\mathrm{E_{p_a}}} \left( \mathop{\mathrm{w_a}} (X_i) \frac{\mathop{\mathrm{f}} (X_i)}{\mathop{\mathrm{p_a}} (X_i)} \right) + \frac{1}{n_b} \sum_{i=1}^{n_b} \mathop{\mathrm{E_{p_b}}} \left( \mathop{\mathrm{w_b}} (Y_i) \frac{\mathop{\mathrm{f}} (Y_i)}{\mathop{\mathrm{p_b}} (Y_i)} \right) = \mathop{\mathrm{E_{p_a}}} \left( \mathop{\mathrm{w_a}} (X_i) \frac{\mathop{\mathrm{f}} (X_i)}{\mathop{\mathrm{p_a}} (X_i)} \right) + \mathop{\mathrm{E_{p_b}}} \left( \mathop{\mathrm{w_b}} (Y_i) \frac{\mathop{\mathrm{f}} (Y_i)}{\mathop{\mathrm{p_b}} (Y_i)} \right) = \int \mathop{\mathrm{w_a}} (x) \frac{\mathop{\mathrm{f}} (x)}{\mathop{\mathrm{p_a}} (x)} \mathop{\mathrm{p_a}} (x) \, dx + \int \mathop{\mathrm{w_b}} (x) \frac{\mathop{\mathrm{f}} (x)}{\mathop{\mathrm{p_b}} (x)} \mathop{\mathrm{p_b}} (x) \, dx = \int \mathop{\mathrm{w_a}} (x) \mathop{\mathrm{f}} (x) \, dx + \int \mathop{\mathrm{w_b}} (x) \mathop{\mathrm{f}} (x) \, dx =  \int \mathop{\mathrm{w_a}} (x) \mathop{\mathrm{f}} (x) + \mathop{\mathrm{w_b}} (x) \mathop{\mathrm{f}} (x) \, dx =  \int \left( \mathop{\mathrm{w_a}} (x) + \mathop{\mathrm{w_b}} (x) \right) \mathop{\mathrm{f}} (x) \, dx = \int \left( \frac{\displaystyle n_a \mathop{\mathrm{p_a}} (x)}{\displaystyle n_a \mathop{\mathrm{p_a}} (x) + n_b \mathop{\mathrm{p_b}} (x)} + \frac{\displaystyle n_b \mathop{\mathrm{p_b}} (x)}{\displaystyle n_a \mathop{\mathrm{p_a}} (x) + n_b \mathop{\mathrm{p_b}} (x)} \right) \mathop{\mathrm{f}} (x) \, dx = \int \left( \frac{\displaystyle n_a \mathop{\mathrm{p_a}} (x) + n_b \mathop{\mathrm{p_b}} (x)}{\displaystyle n_a \mathop{\mathrm{p_a}} (x) + n_b \mathop{\mathrm{p_b}} (x)} \right) \mathop{\mathrm{f}} (x) \, dx = \int \mathop{\mathrm{f}} (x) \, dx$.  
>  
> Consistent  
>> 
>> By **LLN (Law of Large Numbers)**, we have $\displaystyle \lim \limits_{n_a \to \infty} \frac{1}{n_a} \sum_{i=1}^{n_a} \mathop{\mathrm{w_a}} (X_i) \frac{\mathop{\mathrm{f}} (X_i)}{\mathop{\mathrm{p_a}} (X_i)} + \lim \limits_{n_b \to \infty} \frac{1}{n_b} \sum_{i=1}^{n_b} \mathop{\mathrm{w_b}} (Y_i) \frac{\mathop{\mathrm{f}} (Y_i)}{\mathop{\mathrm{p_b}} (Y_i)} = \mathop{\mathrm{E_{p_a}}} \left( \frac{1}{n_a} \sum_{i=1}^{n_a} \mathop{\mathrm{w_a}} (X_i) \frac{\mathop{\mathrm{f}} (X_i)}{\mathop{\mathrm{p_a}} (X_i)} \right) + \mathop{\mathrm{E_{p_a}}} \left( \frac{1}{n_b} \sum_{i=1}^{n_b} \mathop{\mathrm{w_b}} (Y_i) \frac{\mathop{\mathrm{f}} (Y_i)}{\mathop{\mathrm{p_b}} (Y_i)} \right) = \int \mathop{\mathrm{f}} (x) \, dx$.

For more general case, we may have multiple **proposal distribution** $\displaystyle \mathop{\mathrm{p_a}} \, \mathop{\mathrm{p_b}} \, \mathop{\mathrm{p_c}} \, \cdots$. As long as the **weights** fulfill $\displaystyle \mathop{\mathrm{w_a}} + \mathop{\mathrm{w_b}} + \mathop{\mathrm{w_c}} + \cdots = 1$, we have the more general estimator $\displaystyle \int \mathop{\mathrm{f}} (x) \, dx \approx \frac{1}{n_a} \sum_{i=1}^{n_a} \mathop{\mathrm{w_a}} (X_i) \frac{\mathop{\mathrm{f}} (X_i)}{\mathop{\mathrm{p_a}} (X_i)} + \frac{1}{n_b} \sum_{i=1}^{n_b} \mathop{\mathrm{w_b}} (Y_i) \frac{\mathop{\mathrm{f}} (Y_i)}{\mathop{\mathrm{p_b}} (Y_i)} + \frac{1}{n_c} \sum_{i=1}^{n_c} \mathop{\mathrm{w_c}} (Z_i) \frac{\mathop{\mathrm{f}} (Z_i)}{\mathop{\mathrm{p_c}} (Z_i)} + \cdots$.  

And we have the more general **balance heuristic** **weights** $\displaystyle \mathop{\mathrm{w_a}} (X_i) = \frac{\displaystyle n_a \mathop{\mathrm{p_a}} (X_i)}{\displaystyle n_a \mathop{\mathrm{p_a}} (X_i) + n_b \mathop{\mathrm{p_b}} (X_i) + n_c \mathop{\mathrm{p_c}} (X_i) + \cdots} \, \mathop{\mathrm{w_b}} (X_i) = \frac{\displaystyle n_b \mathop{\mathrm{p_b}} (X_i)}{\displaystyle n_a \mathop{\mathrm{p_a}} (X_i) + n_b \mathop{\mathrm{p_b}} (X_i) + n_c \mathop{\mathrm{p_c}} (X_i) + \cdots} \, \mathop{\mathrm{w_c}} (X_i) = \frac{\displaystyle n_c \mathop{\mathrm{p_c}} (X_i)}{\displaystyle n_a \mathop{\mathrm{p_a}} (X_i) + n_b \mathop{\mathrm{p_b}} (X_i) + n_c \mathop{\mathrm{p_c}} (X_i) + \cdots} \,  + \cdots$.  
