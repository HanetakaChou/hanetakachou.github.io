...
$\displaystyle \operatorname{\rho_{hd}}(\overrightarrow{\omega_o})$ | HDR (Hemispherical-Directional Reflectance) | N/A  
...
Evidently, the **MIS** is NOT efficient in real time rendering. By "Equation 9.9" of [Real-Time Rendering Fourth Edition](https://www.realtimerendering.com/), "14.1.3 Specular Reflection and Transmission" of [PBR Book V3](https://pbr-book.org/3ed-2018/Reflection_Models/Basic_Interface#Reflectance) and "Equation 4.12" of [PBR Book V4](https://pbr-book.org/4ed/Radiometry,_Spectra,_and_Color/Surface_Reflection#TheBRDFandtheBTDF), we have the **HDR** (Hemispherical-Directional Reflectance) $\displaystyle \operatorname{\rho_{hd}} (\overrightarrow{\omega_o}) = \int_\Omega \operatorname{f}(\overrightarrow{\omega_i}, \overrightarrow{\omega_o}) \cdot max(0, \cos \theta_i) \, d \overrightarrow{\omega_i}$.  By "14.1.3 Specular Reflection and Transmission" of [PBR Book V3](https://pbr-book.org/3ed-2018/Light_Transport_I_Surface_Reflection/Sampling_Reflection_Functions#SpecularReflectionandTransmission) and "14.1.3 Specular Reflection and Transmission" of [PBR Book V4](https://pbr-book.org/3ed-2018/Light_Transport_I_Surface_Reflection/Sampling_Reflection_Functions#SpecularReflectionandTransmission), based on the **Dirac Delta Distribution**, the area light can be approximated by the punctual light, and we have the Whitted integrator that $\displaystyle \operatorname{L_o}(\omega_o) = \int_\Omega \operatorname{f}(\omega_o, \omega_i) \cdot \operatorname{L_i}(\omega_i) \cdot max(0, \cos \theta_i) \, d\omega_i = \operatorname{\rho_{hd}} \cdot \operatorname{L_i}(\omega_i)$.  

Although the **HDR** $\displaystyle \operatorname{\rho_{hd}}(\overrightarrow{\omega_o})$ can be precalculated offline, the Whitted integrator is still NOT efficient enough in real time rendering. By \[Lagarde 2014\], we usually have the irradiance perpendicular to the light direction $\displaystyle \mathrm{E_L}$ and the irradiance perpendicular to the surface normal direction $\displaystyle \mathrm{E_N}$ , and we have the approximation of the outgoing radiance of the punctual light that $\displaystyle \operatorname{L_o}(\omega_o) = \int_\Omega \operatorname{f}(\omega_o, \omega_i) \cdot \operatorname{L_i}(\omega_i) \cdot max(0, \cos \theta_i) \, d\omega_i = \operatorname{\rho_{hd}} \cdot \operatorname{L_i}(\omega_i) \approx \operatorname{f}(\omega_o, \omega_i) \cdot \mathrm{E_L} \cdot \mathrm{NdotL} = \operatorname{f}(\omega_o, \omega_i) \cdot \mathrm{E_N}$.  
...
By "Equation 9.9" of [Real-Time Rendering Fourth Edition](https://www.realtimerendering.com/), "14.1.3 Specular Reflection and Transmission" of [PBR Book V3](https://pbr-book.org/3ed-2018/Reflection_Models/Basic_Interface#Reflectance) and "Equation 4.12" of [PBR Book V4](https://pbr-book.org/4ed/Radiometry,_Spectra,_and_Color/Surface_Reflection#TheBRDFandtheBTDF), we have the **HDR** (Hemispherical-Directional Reflectance) $\displaystyle \operatorname{\rho_{hd}} (\overrightarrow{\omega_o}) = \int_\Omega \operatorname{f}(\overrightarrow{\omega_i}, \overrightarrow{\omega_o}) \cdot max(0, \cos \theta_i) \, d \overrightarrow{\omega_i}$.  

The **HDR** $\displaystyle \operatorname{\rho_{hd}} (\overrightarrow{\omega_o})$ is essentially the norm of the BRDF cosine, and we have the normalized BRDF cosine $\displaystyle \frac{\operatorname{f}(\overrightarrow{\omega_i}, \overrightarrow{\omega_o}) \cdot max(0, \cos \theta_i)}{\operatorname{\rho_{hd}} (\overrightarrow{\omega_o})}$.  
